...
LV.comp.pop.dyn <- function(sp1,sp2,generation,growth.rate.1, growth.rate.2,K1,K2,N12.coefficient,N21.coefficient){
  N1 <- sp1
  N2 <- sp2
...
q <- LV.comp.pop.dyn(sp1 = 10, sp2 = ,10, generation = 30,
